...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>El server de Camille</h1>", unsafe_allow_html=True)
    ...
    col1.image("Image.jpeg", caption='coc0nudes', width=350)
    ...
    texto = """
    Mi nombre es Camille Whetteckey Torres, nací el 1 de marzo y soy natural de Trujillo, Perú. 
    Actualmente curso el quinto ciclo de la carrera de Periodismo. Me interesa profundizar en el análisis de los medios, la escritura como herramienta crítica y las formas contemporáneas de narrar la realidad.
    Entre mis principales intereses personales se encuentran el cine latinoamericano y las series, así como la lectura y escritura de poesía, las cuales me permiten explorar sensibilidades y perspectivas diversas. 
    También, desde el lado musical, me considero fanática de la cantante Fiona Apple, como de Sade, PJ Harvey, entre otras cantantes. 
    Además, practico el maquillaje artístico como una forma de expresión creativa y visual. 
    Estas actividades complementan mi formación académica y considero que enriquecen mi mirada como futura comunicadora.
    """
    ...
    texto_2 = """
    Mi experiencia aprendiendo a programar ha sido retadora pero enriquecedora. 
    Si bien contaba con conocimientos previos en HTML, adentrarme en Python implicó enfrentar nuevas lógicas y estructuras. 
    Uno de los mayores desafíos que tuve fue memorizar y aplicar correctamente todas las funciones vistas en clase, especialmente al momento de combinarlas para resolver problemas específicos. 
    Sin embargo, con práctica constante y revisando ejemplos, considero que he logrado afianzar un nivel básico de programación que me permitió desarrollar un proyecto final funcional, el cual 
    incluye buscador como portal de transparencia política que tiene como objetivo facilitar el acceso a información pública relevante. 
    Por ello, creo que esta experiencia me ha motivado a seguir explorando el cruce entre el periodismo, la tecnología y la ciudadanía, ello con la meta de ampliar la accesibilidad a la información desde la programación.
    """
    ...
    st.markdown("<h2 style='text-align: center;'>Presentación de video exponiendo</h2>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/1XiiXcadgMFsC9MtYX9pm0tOYZLbCQVxr/view?usp=drive_link' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
    ...
    st.markdown("<h1 style='text-align: center;'>Mis gráficos interactivos</h1>", unsafe_allow_html=True)

    # Creamos una lista de gráficos
    graficos = ['Nube de palabras Twitter', 'Gráfico de pastel de Netflix', 'mapa_peliculas']
    ...
    if grafico_seleccionado == 'Nube de palabras Twitter':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>El gráfico que muestra la nube de palabras presenta la recopilación de frecuencias que se recolectaron de una base de datos textual a partir de Tweets de la plataforma X.</div>", unsafe_allow_html=True)
        st.image("nube_palabras_datospc3_conexion.png", caption='Nube de palabras Twitter', width=500)
        pass
        ...
        st.markdown("<div style='text-align: justify; font-size: 20px;'>El mapa interactivo presenta las locaciones de mis 5 películas favoritas (Isla de Perros, Todo sobre mi madre, Las mujeres de verdad tienen curvas, Orgullo y prejuicio y Medianeras).</div>", unsafe_allow_html=True)
